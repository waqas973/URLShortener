...
define('JAZZCASH_MERCHANT_ID', 'MC15489');
define('JAZZCASH_PASSWORD', 'z9468v2wfx');
define('JAZZCASH_INTEGERITY_SALT', '1au1uz2z5t');
define('JAZZCASH_RETURN_URL', 'http://localhost/fyp_project/Business/order_placed.php');
