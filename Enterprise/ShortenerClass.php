<?php 
 ...
 class shotener 
 {
   ...
   function __construct($pdo,$expire_date,$url_type,$short_words,$custom_words){
            ...
            if($shortCode == false){
                if($this->short_words  == 'random'){
                  $shortCode =  $this->CreateShortCode($long_Url);
                    ...
                    $shortCode =  $this->CreateCustomcode($long_Url,$this->custom_words);
                }
            }
...
protected function CreateCustomcode($long_Url,$custom_words){
    $shortCode = $custom_words;
    $id  = $this->insertUrlInDB($long_Url , $custom_words);
