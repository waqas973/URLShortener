...
ini_set('max_execution_time', 60);
 ...
 $id = $_GET['id'];
 $cus_sql =  "select * from customers where customer_id=:id ";
 $stmt_cus_email =   $conn->prepare($cus_sql);
 ...
 $results_id = $stmt_cus_email->fetch(PDO::FETCH_ASSOC);
 if($stmt_cus_email->rowCount() > 0){
 
 $product_name = $results_id['package_type'];
 $product_price = $results_id['total_price'];
  ...
  <section class="showcase">
    <div class="container">
      <div class="pb-2 mt-4 mb-2 border-bottom">
        <h2>Continue to JAZZCASH Checkout</h2>
      </div>      
        ...
        <!--Form with header-->
            <div class="card border-gray rounded-0">
                <div class="card-header p-0">
                    ...
                    <h6 class="pl-2 text-primary"><strong>Package Name: </strong> <?php echo $product_name;?> </h6>
                        <h6 class="pl-2 text-primary"><strong>Total Price: </strong> <?php echo $product_price;?> PKR</h6>
                    </div>
                </div>
                ...
                <div class="card-body p-3">   
					...
					<p style="color:black;">JazzCash Mobile Account can be registered on any Jazz or Warid number</p>
					<p style="color:black;">Biometric-verified Jazz and Warid customers can self-register their Mobile Account simply by dialing *786#.</p>                              
